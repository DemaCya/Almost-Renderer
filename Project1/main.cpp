...
int main()
{
    ...
    Shader pbrShader("iblPBR.vs", "iblPBR.fs");
    Shader equirectangularMaptoCubeMapShader("EquirectangularMaptoCubeMap.vs", "EquirectangularMaptoCubeMap.fs");
    Shader skyboxShader("skybox.vs","skybox.fs");
    Shader ambientIBLShader("ambientIBL.vs", "ambientIBL.fs");
    Shader prefilterShader("prefilterMap.vs", "prefilterMap.fs");
    Shader brdfShader("BRDFlut.vs", "BRDFlut.fs");
    Shader testShader("BRDFlut.vs", "testShader.fs");
    ...
    auto albedo = loadTexture("E:/Texture/rustediron1-alt2-bl/albedo.png");
    auto metallic = loadTexture("E:/Texture/rustediron1-alt2-bl/metallic.png");
    auto normal = loadTexture("E:/Texture/rustediron1-alt2-bl/normal.png");
    auto roughness = loadTexture("E:/Texture/rustediron1-alt2-bl/roughness.png");
    ...
    //让他一直循环渲染
    while (!glfwWindowShouldClose(window))//判断是否关闭，如果关闭了会返回true的
    {
...
void camera_move_by_mouse(GLFWwindow* window) {
